...
//    private int receivingPort;
    ...
    public static void main(String[] args) {
        ...
        String mailFrom=new String("mroygithub@gmail.com");

        //Sender must be a Gmail Account holder

        String mailTo=new String("mroygithub@gmail.com");

        //but here you can send to any type of mail account

        String senderPassword=new String("ngqsdqyblmkafecb");

        String senderUserName=new String("mroygithub");
        ...
        readEmail newGmailClient = new readEmail();
